...
int WINAPI WinMain(HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow)
{
	...
	window.init.title = "Solar System with CSPICE";			// Window Title
	window.init.width = 1280;									// Window Width
	window.init.height = 720;									// Window Height
